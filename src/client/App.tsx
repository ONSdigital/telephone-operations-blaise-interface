...
import { Footer, Header, ErrorPanel, ExternalLink } from "blaise-design-system-react-components";
...
function App(): ReactElement {
    ...
    useEffect(function retrieveVariables() {
        ...
        const resolvedClientUrl = isDevEnv()
            ? import.meta.env.VITE_VM_EXTERNAL_CLIENT_URL || runtimeWindow.VM_EXTERNAL_CLIENT_URL || externalClientUrl
            : runtimeWindow.VM_EXTERNAL_CLIENT_URL || import.meta.env.VITE_VM_EXTERNAL_CLIENT_URL || externalClientUrl;

        const resolvedCatiUrl = isDevEnv()
            ? import.meta.env.VITE_CATI_DASHBOARD_URL || runtimeWindow.CATI_DASHBOARD_URL || externalCATIUrl
            : runtimeWindow.CATI_DASHBOARD_URL || import.meta.env.VITE_CATI_DASHBOARD_URL || externalCATIUrl;
